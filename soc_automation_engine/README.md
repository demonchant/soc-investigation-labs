...
> A production structured demonstration Security Operations Center (SOC) automation pipeline that ingests logs, normalizes events, applies mapped to MITRE ATT&CK detection rules, and generates structured incident reports.
