...
> A detection as code library of 10 lab validated Splunk SPL queries mapped to MITRE ATT&CK. Includes a CI/CD inspired validation engine that checks rule schema, MITRE format, SPL completeness, and tuning guidance before deployment.
