...
> A production structured demonstration SOC threat intelligence pipeline for enriching IPs, domains, and file hashes with reputation data, geographic risk analysis, and structured risk scoring.
...
The VirusTotalProvider in providers/virustotal.py is lab validated. Swap out MockProvider in core/enricher.py to activate live lookups.
