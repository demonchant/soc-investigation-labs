...
> Parses Windows Security Event Log and Sysmon telemetry, runs 9 mapped to MITRE ATT&CK detection modules against process, logon, registry, and file events, triages alerts by composite risk score, and groups related detections into incident chains for escalation.
